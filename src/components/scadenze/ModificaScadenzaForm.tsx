...
export function ModificaScadenzaForm({ scadenza }: { scadenza: Scadenza }) {
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    const payload: ScadenzaUpdate = {
      titolo:           data.titolo,
      tipo:             data.tipo,
      data:             data.data,
      frequenza:        (data.frequenza ?? 'nessuna') as ScadenzaUpdate['frequenza'],
