...
import { User, Bell, MapPinned, ChevronRight } from 'lucide-react'
      ...
      <div className="px-5 pt-2">
        ...
        >
          <div className="flex items-start justify-between gap-4">
            ...
            <div className="flex h-10 w-10 shrink-0 items-center justify-center rounded-full border border-[#EADFD3] bg-[#FFF9F5] text-slate-600">
